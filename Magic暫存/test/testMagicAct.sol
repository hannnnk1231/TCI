...
contract TestMagicAct {	
	...
	function testAct() public {
		uint expectedType = 1;
		uint initMagicianBalance = magicAct.magician().balance;
		...
		Assert.equal(magicAct.magician().balance, initMagicianBalance + 100 finney, "The magician should earn 100 finney.");
	...
	function testPayMagician() public {
		...
		Assert.equal(magicAct.magician().balance, initMagicianBalance + 200 finney, "The magician should earn 200 finney.");
